...
LLM_SUMMARIZER_MODEL = os.getenv("LLM_SUMMARIZER_MODEL", "qwen2.5:1.5b-instruct")
LLM_SUMMARIZER_URL = os.getenv("LLM_SUMMARIZER_URL", "http://localhost:11435/api/generate")
